    ...
    public class DataInitializer {
        ...
        public void InitializeData() {
            ...
            if (_dbContext.Database.EnsureCreated()) {
                ...
                MyImage image1 = new MyImage("Header","ISO-200","1/80 sec","f/5.6","Belgium",Image.FromFile("Images/IMG_9157c.jpg"));
                _imageRepository.Add(image1);

                MyImage image2 = new MyImage("Parallax1","ISO-100","1/200 sec","f/10","Italy",Image.FromFile("Images/DSC_2544c2.jpg"));
                _imageRepository.Add(image2);

                MyImage image3 = new MyImage("Parallax2", "ISO-100", "1/320 sec", "f/5.6", "Italy", Image.FromFile("Images/DSC_2648c3.jpg"));
                _imageRepository.Add(image3);

                MyImage image4 = new MyImage("Parallax3", "ISO-500", "6 sec", "f/4.5", "Italy", Image.FromFile("Images/DSC_3043c2.jpg"));
